...
import com.sneha.homepage.ml.DiseaseDetection;
...
public class CamActive extends AppCompatActivity {
    ...
    private void classifyImage(Bitmap image) {
        try {
            ...
            String[] classes = {"Pepper Bell Bacterial Spot", "Healthy Pepper Bell"};
            final String selectedClass = classes[maxPos];  // ADD THIS LINE
            result.setText(selectedClass);  // CHANGE THIS

            result.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    // to search disease on internet
                    String query = selectedClass.replace(" ", "+") + "+plant+disease";  // CHANGE THIS
